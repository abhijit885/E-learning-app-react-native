...
const RegistrationVerifecationOTP_Varifecation = ({ navigation }) => {
    ...
    return (
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={{ marginTop: 50, width: '100%', height: 70, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Text style={{ fontWeight: '200', fontFamily: 'roboto-regular', }}>OTP has been sent to your Email</Text>
            </View>
...
export default RegistrationVerifecationOTP_Varifecation;
